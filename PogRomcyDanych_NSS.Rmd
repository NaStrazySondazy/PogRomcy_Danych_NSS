...
Jak widać wyniki symulacji nie odbiegają od tego, co przewidywaliśmy. w `r p2.Tab$Freq[p2.Tab$Var1=="0%"]  ` próbach absencja wyborcza wyniosła 0%, w `r p2.Tab$Freq[p2.Tab$Var1=="50%"]` wyniosła 50%, a w `r p2.Tab$Freq[p2.Tab$Var1=="100%"]` wyniosła 100%. Różnice są niewielkie. Widzimy więc teraz, że schemat losowania próby determinuje szansę uzyskania poprawnego oszacowania. W przypadku naszego badania wynoszą one 200/380, a więc około 53%.
