...
Łącznie prób sześcioosobowych, w których dostępny jest przynajmniej 1 respondent jest `r print(realizacja[10,2], digits = 16)`. Oznacza to, że łączna liczba dostępnych prób będzie mniejsza niż poprzenio. Inaczej też rozłożą się wyniki z prób.
