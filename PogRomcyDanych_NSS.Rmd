...
par(mar=c(5,4,1,0), col.axis = kolor)
b.6<-barplot(c(10*9, 20*10, 10*9), las=1, ylim=c(0, 230))
rect(par("usr")[1], par("usr")[3], par("usr")[2], par("usr")[4], col = "grey90")
abline(h=seq(0,100,50), col="grey100");
abline(v=b.6, col="grey100");
barplot(c(10*9, 20*10, 10*9), las=1, names.arg = c("0%", "50%", "100%"), add=T, col=kolor, ylim=c(0, 230), ylab = "Liczba prób", xlab="Poziom absencji wyborczej w próbie", cex.names = 1.5 );
box( col = "grey90")
