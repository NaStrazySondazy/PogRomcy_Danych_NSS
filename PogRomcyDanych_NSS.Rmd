...
kable( poparcie_dla_P, format = "markdown");
```
W stosunku do badania absencji wyborczej zmienimy niewiele. Po prostu w kolumnie “Glosowanie” zamiast wartości -1  teraz będziemy analizowali występowanie wartości 1, czyli glosowanie na partię X. Będziemy również dobierać nie 2, a 6 obywateli do próby. Tak samo jak wcześniej zastosujemy jednak losowanie proste bez zwracania i technikę CAPI. Pytanie w kwestionariuszu będzie natomiast brzmiało: "Gdyby wybory do sejmu odbywały się w najbliższą niedzielę to czy zagłosowałaby/łby Pani/an na partię X"    
